...
export const metadata: Metadata = {
    title: "M.Sc. IT | Dhirubhai Ambani University",
    description: "Admission Enquiry Website for MSc.IT. at Dhirubhai Ambani University",
};
      ...
      <section id="top-faculty">
        <TopFaculty />
            ...
            <section id="contact-form">
                <ContactForm redirectUrl="https://www.daiict.ac.in/admission-msc-it" />
            </section>
            <section id="details">
                <Footer />
            </section>
