  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-20 relative">
        ...
        >
          <motion.a
            href="#application-form-bottom"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-red-600 hover:bg-red-700 text-white px-16 py-4 text-xl font-bold rounded-lg text-center w-full flex items-center justify-center gap-2 cursor-pointer"
            onClick={e => {
              e.preventDefault();
              const el = document.getElementById("application-form-bottom");
