...
<div className="pt-4 flex gap-4">
  <Button
    type="submit"
    className={`flex-1 bg-red-500 hover:bg-amber-600 text-white p-3 rounded-md text-center flex items-center justify-center gap-2 h-14`}
    disabled={isSubmitting || !formData.authorized}
    style={{
      opacity: isSubmitting || !formData.authorized ? 0.6 : 1,
      cursor: isSubmitting || !formData.authorized ? "not-allowed" : "pointer",
    }}
  >
    {isSubmitting ? (
      "Submitting..."
  ...
  <a
    href="/BTech_DAU.pdf"
    download
    className="flex-1 bg-green-600 hover:bg-green-700 text-white p-3 rounded-md text-center flex items-center justify-center gap-2 h-14"
