...
export const metadata: Metadata = {
    title: "M.Sc. DS | Dhirubhai Ambani University",
    description: "Admission Enquiry Website for MSc.DS. at Dhirubhai Ambani University",
};
      ...
      <section id="top-faculty">
        <TopFaculty />
            ...
            <section id="contact-form">
                <ContactForm redirectUrl="https://www.daiict.ac.in/admission-msc-data-science"/>
            </section>
            <section id="details">
                <Footer />
            </section>
